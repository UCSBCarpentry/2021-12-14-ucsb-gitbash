...
address: "Online, the information you need to connect to this meeting is found in the "Attendance Reminder" Emails."      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humandate: "Dec 14 and 15, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Kristi Liu","Renata Curty", "Jon Jablonski"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Anita Carraher", "Amanda Ho", "Annie Huang", "Connor Levenson", "Amelia Meyers"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<p>
We will use this <a href="https://pad.carpentries.org/2021-14-12-ucsb-gitbash-online">collaborative document</a> for chatting, taking notes, and sharing URLs and bits of code.
</p>
<hr/>
